...
class DetailHehaSkyViewFragment : Fragment() {
    private lateinit var btnFavorite: ImageView
    private val destinationName = "HeHa Sky View"
    private val destinationImage = R.drawable.heha_sky
    
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_detail_heha_sky_view, container, false)
    }
