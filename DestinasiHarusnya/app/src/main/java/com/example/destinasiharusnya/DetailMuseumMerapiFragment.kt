...
class DetailMuseumMerapiFragment : Fragment() {
    private lateinit var btnFavorite: ImageView
    private val destinationName = "MUSEUM GUNUNG MERAPI"
    
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_detail_museum_merapi, container, false)
    }
    ...
    private fun toggleFavorite() {
        if (WishlistManager.isInWishlist(destinationName)) {
            ...
            val destination = Destination(
                destinationName,
                "Jl Kaliurang Km 22, Kec. Pakem, Kab. Sleman, D.I.Y",
                "Rp5.000",
                R.drawable.museum_merapi
            )
