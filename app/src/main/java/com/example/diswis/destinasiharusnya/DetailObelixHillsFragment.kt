...
class DetailObelixHillsFragment : Fragment() {
    private lateinit var btnFavorite: ImageView
    private val destinationName = "Obelix Hills"
    private val destinationImage = R.drawable.obelix
    
    override fun onCreateView(
        inflater: LayoutInflater, container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        return inflater.inflate(R.layout.fragment_detail_obelix_hills, container, false)
    }
